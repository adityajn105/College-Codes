...
<h4 align="center" style="font:bold 30px Comic Sans MS;
    ...
    Bookings done by Guests(Left Join)</h4>
<hr>
<%
    ...
    try {
        ...
        preparedStatement=con.prepareStatement(
                "select hotel_no,room_no,GUESTS.guest_no,name,date_from,date_to from BOOKINGS " +
                        "left join GUESTS on BOOKINGS.guest_no=GUESTS.guest_no");
...
<table align="center">
    ...
    <tr>
        ...
        <td width="20%" align="center"><%out.print(gno);%></td>
